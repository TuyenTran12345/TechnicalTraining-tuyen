...
class TestFreightNaming(TestCommon):
    ...
    def test_023_name_get_display_with_port(self):
        """Test Case: name_get should display port for local charges"""
        freight = self.env['product.template'].create({
            'detailed_type': 'freight',
            'support_freight_name': 'auto',
            'route_id': self.route_dinhvu_usa.id,
        ...
        freight_display = freight.name_get()[0][1]
        ...
        local_charge_display = local_charge.name_get()[0][1]
