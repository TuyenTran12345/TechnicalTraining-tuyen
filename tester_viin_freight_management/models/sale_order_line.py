...
class SaleOrderLine(models.Model):
    ...
    def _prepare_route_vals(self):
        ...
        return {
            ...
            'origin_id': route.address_from_id.id,
            'destination_id': route.address_to_id.id,
    ...
    def _prepare_shipment_vals(self):
        ...
        if route.service_type == 'port_to_port':
            shipment_vals.update({
                'port_of_loading_id': route.address_from_id.id,
                'port_of_discharge_id': route.address_to_id.id,
            })
